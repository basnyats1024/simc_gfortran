...
! Commented out by Samip, UofRegina to solve the issue with decay.. Previously had problems with rates when the decay flag was turned off but commenting this section out seems to have solved the issue.
